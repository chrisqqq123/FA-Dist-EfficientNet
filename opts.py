...
def add_dataset_flags(parser):
    parser.add_argument('--data_dir', default='/home/xyz3/FA_test/data',
    ...
    parser.add_argument('--num-workers', '-j', default=4, help="Number of "
...
def add_model_flags(parser):
    ...
    parser.add_argument('--coslinear', default=True, help="Using coslinear"
                        " detect using which lossfunction.", type=bool)
    parser.add_argument('--s', default=5.0, help="scaling factor"
